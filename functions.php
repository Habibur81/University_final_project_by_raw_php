...
function getCats(){
 ...
 ///ending getCats function///
  
///beging getpcatpro function///
    ...
    if(isset($_GET['p_cat'])){
        ...
        if($count==0){
            ...
            echo "
                ...
                <h1> No Product Foound In This Product Categories </h1>
